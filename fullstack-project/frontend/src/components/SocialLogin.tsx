...
export const SocialLogin: React.FC = () => {
  const handleSocialClick = (platform: string) => {
    alert(`${platform} authentication simulated!`);
  };
  ...
  return (
    <div className="w-full space-y-3.5">
      ...
      <button
        ...
        className="w-full h-11 border border-zinc-200 bg-white hover:bg-zinc-50 transition duration-300 flex items-center justify-center relative cursor-pointer"
      >
      ...
      <button
        ...
        className="w-full h-11 border border-zinc-200 bg-white hover:bg-zinc-50 transition duration-300 flex items-center justify-center relative cursor-pointer"
      >
        <span className="absolute left-4 text-[#1877F2]">
